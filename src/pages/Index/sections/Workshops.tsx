        ...
        {viewType === 'cards' ? (
          <Tabs defaultValue="spring-summer" className="mb-12">
            ...
            <TabsContent value="spring-summer">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {workshops.filter(w => w.category === 'spring-summer').map((workshop, index) => (
            ...
            <TabsContent value="fall">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {workshops.filter(w => w.category === 'fall').map((workshop, index) => (
                  <WorkshopCard key={index} workshop={workshop} />
                ))}
              </div>
            </TabsContent>
            ...
            <TabsContent value="retreat">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {workshops.filter(w => w.category === 'retreat').map((workshop, index) => (
                  <WorkshopCard key={index} workshop={workshop} />
                ))}
              </div>
            </TabsContent>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-8">
              {months.map(month => (
                <div key={month} className="bg-white rounded-lg p-6 shadow-md">
                  <h4 className="text-xl font-bold text-primary mb-4 flex items-center gap-2">
                    <CalendarIcon /> {month} 2025
                  </h4>
                  <div className="space-y-4">
                    {filterByMonth(month).map((workshop, idx) => (
                      <div key={idx} className="flex flex-col md:flex-row gap-4 border-b border-gray-100 pb-4">
