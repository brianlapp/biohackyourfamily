...
const Workshops = () => {
  return <section id="workshops" className="py-12 md:py-20 bg-gray-50">
      <div className="container px-4 sm:px-6">
        ...
        <div className="mb-12">
          <h3 className="text-xl md:text-2xl font-semibold mb-6 text-center">Upcoming Spring, Summer, and Fall 2025 Workshops:</h3>
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {retreats.map((retreat, index) => <WorkshopCard key={index} workshop={retreat} />)}
          </div>
        </div>
